...
def test_embeddings_train_fastrp_gb(train_endpoints: TrainArrowEndpoints, arrow_client_runtime: AuthenticatedArrowClient, sample_graph: Graph) -> None:
...
@ignore_preview_warning
def test_embeddings_train_graphsage_mlp(arrow_client_runtime: AuthenticatedArrowClient, train_endpoints: TrainArrowEndpoints, sample_graph: Graph) -> None:
